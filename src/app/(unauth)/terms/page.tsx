    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <p>
            Welcome to SermonVault. By using our services, you agree to these
            terms. Please read them carefully.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">1. Use of Service</h2>
          <p>
            SermonVault provides an AI-powered platform for sermon analysis and
            insights. You must use this service only as permitted by law. We may
          ...
          <p>
            SermonVault&apos;s privacy policies explain how we treat your
            personal data and protect your privacy when you use our Services. By
            using our services, you agree that SermonVault can use such data in
          ...
          <p>
            SermonVault allows you to upload, submit, store, send or receive
            ...
            or receive content to or through our Services, you give SermonVault
          ...
          <p>
            Our service uses AI to process and analyze your sermon content.
            While we strive for accuracy, you acknowledge that AI-generated
            insights may not always be perfect and should be used as a tool to
            aid, not replace, human interpretation and understanding.
          </p>
          ...
          <p>
            ...
            SermonVault may also stop providing Services to you, or add or
          ...
          <p>
            When permitted by law, SermonVault, and SermonVault&apos;s suppliers
            and distributors, will not be responsible for lost profits,
          ...
          <p>
            ...
            accepts these terms. It will hold harmless and indemnify SermonVault
          ...
          <p>
            ...
            our Services. You should look at the terms regularly. We&apos;ll
            post notice of modifications to these terms on this page. Changes
